...
const Company = () => (
  <Layout type="company">
      ...
      <div className="card">
        ...
        <ul>
          <li>Parent, stepparent or guardian is employed as a full-time employee of Brunswick Corporation, or one of its divisions/subsidiaries on March 16, 2020 and who has worked for Brunswick for at least one year of continuous service in the previous five years. Employees and spouses of employees are not eligible to apply.</li>
          ...
          <li>Entering full-time into an accredited college, university or vocational school in fall of 2020.</li>
